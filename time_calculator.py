def add_time(start, duration, day_of_week= False):
    ...
    days_of_the_week_index = {"sunday":0, "monday":1, "tuesday":2, "wednesday":3, "thrusday": 4, "friday":5, "saturday":6}

    days_of_the_week_array = ['Sunday','Monday','Tuesday','Wednesday','Thrusday','Friday','Saturday']
    ...
    end_minutes= start_minutes + duration_minute
    if (end_minutes >= 60):
      start_hours +=1
